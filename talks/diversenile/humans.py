...
FROM amulets a
JOIN burials b ON b.burial_id = a.burial_id
WHERE b.dating = 'napatan' AND b.site_id IN (4,5,6,7,8,9,10) AND (temp_early = '25th' OR temp_late = 'EN') AND social_group = 'non-elite'
GROUP BY 1,2,3
"""
...
pio.write_image(fig, 'talks/diversenile/images/humans.png',scale=3, width=550, height=450)