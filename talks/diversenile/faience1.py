...
SELECT
    b.social_group,
    a.material,
    COUNT(amulet_id) AS faience_count,
...
df['percentage'] = round(df['faience_count'] * 100.0 / df['total_amulets'], 1)
...
pio.write_image(fig, 'talks/diversenile/images/faience1.png',scale=3, width=220, height=300)