...
fig = px.bar(
    ...
    x='phase',
    y='percentage',
    facet_col='material_type',
    text=df_final['percentage'].round(1),
    template="plotly_white",
    title='Distribution of local and imported amulet materials (in %)',
...
pio.write_image(fig, 'talks/diversenile/images/materials_imp-exp.png',scale=3, width=550, height=450)