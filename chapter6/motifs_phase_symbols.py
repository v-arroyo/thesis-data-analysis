...
FROM forms
WHERE form NOT IN ('udjat', 'quadruple udjat')
GROUP BY 1,2,3,4
"""
...
df_final = df_final.sort_values('form')
...
pio.write_image(fig, 'images/chapter6/motifs_phase_symbols.png',scale=3, width=550, height=350)