...
where dating = 'napatan' and b.site_id in (1,2,4,5,6,7,8,9,10) and social_group = 'non-elite'
group by 1,2,3
"""
...
pio.write_image(fig, 'images/chapter6/types_region_non-elite.png',scale=3, width=550, height=250)