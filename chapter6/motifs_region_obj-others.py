...
fig = px.bar(
    ...
    barmode='stack',
    title='Distribution of object and miscellaneous amulets by social group and region (in %)',
...
pio.write_image(fig, 'images/chapter6/motifs_region_obj-others.png',scale=3, width=550, height=250)